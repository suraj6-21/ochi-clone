...
const Footer = () => {
  return (
    <div className="w-full h-screen flex gap-5 p-20 bg-zinc-900 font-['Founders_Grotesk_X-Condensed'] ">
      ...
      <div className="w-1/2 h-full flex flex-col justify-between">
        ...
        <div className="social-media font-['Neue_Montreal'] text-[1.2vw] mt-10 ">
          <h3 className="block font-light mb-5">S:</h3>
          <a className="block font-light" href="#">
            Facebook
          </a>
          <a className="block font-light" href="#">
            Instagram
        ...
        <div className="social-media flex justify-between font-['Neue_Montreal'] mt-10 ">
          <div className="main-l flex flex-col gap-3">
            <h3 className="block font-light ">L:</h3>
          ...
          <div className="main-m">
            <h3 className="block font-light mt-6">S:</h3>
            <a className="block font-light" href="#">
              Home
            </a>
            <a className="block font-light" href="#">
        ...
        <div>
          <h3 className="block font-['Neue_Montreal'] font-light mt-6">E:</h3>
          <a className="block font-['Neue_Montreal'] font-light" href="#">
            hello@ochi.design
          </a>
        </div>

        {/* <div className="font-['Neue_Montreal'] text-md flex justify-between p-5">
          <h3 className="font-light">© ochi design 2024. Legal Terms</h3>
          <h3 className="font-light">Website by Obys</h3>
        </div> */}
      </div>
    </div>
  );
